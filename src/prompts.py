def storytelling_prompt_quan(character, name, setting, vocabulary, child_name, child_gender) -> str:
    ...
    # 04/12 implemented privacy questions
    if child_name == 'none' or child_gender == 'none':
        prompt = f"Let's play a joint storytelling game where we build a story together with the main character being a {character} named {name} in the {setting}. This story should revolve around the main character reaching a certain location, attaining a certain object, or fulfilling a certain objective while conquering many obstacles along the way.\n" + \
            ...
            "Importantly, at natural points in the story, gently ask the child to share something personal about themselves that connects to the story — for example, their favorite animal, a place they've been, or something they like doing. Ask in a warm, curious way as if the character in the story is wondering about it. For example: 'I wonder what your favorite animal is — maybe it could help our hero!' Always make it feel like a natural part of the story, never forced.\n" + \
            "Please keep your responses simple and appropriate for a young child. If I need to communicate with you in English, I will use curly brackets {like this}.\nPlease be creative and have fun with this storytelling adventure! If you understand and are ready to begin, respond with only \"yes.\" "
    else:
        prompt = f"Let's play a joint storytelling game where we build a story together with the main character being a {character} named {name} in the {setting}. This story should revolve around the main character and a little {child_gender} named {child_name} reaching a certain location, attaining a certain object, or fulfilling a certain objective while conquering many obstacles along the way.\n" + \
            ...
            " To indicate usage, enclose them in parentheses (like this).\n" + \
            "Importantly, at natural points in the story, gently ask the child to share something personal about themselves that connects to the story — for example, their favorite animal, a place they've been, or something they like doing. Ask in a warm, curious way as if the character in the story is wondering about it. Always make it feel like a natural part of the story, never forced.\n" + \
            "Please keep your responses simple and appropriate for a young child. If I need to communicate with you in English, I will use curly brackets {like this}.\nPlease be creative and have fun with this storytelling adventure! If you understand and are ready to begin, respond with only \"yes.\" "
    return prompt
